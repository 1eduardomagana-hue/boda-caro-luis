export const COLORS = {
  cream: '#FAF8F5', beige: '#F0EBE3', sand: '#E8DDD1',
  taupe: '#C4AFA0', champagne: '#D4B896', gold: '#B8975A',
  warmGray: '#8B7D72', darkTaupe: '#5C4D44', text: '#3D2E27',
  textLight: '#8B7D72', white: '#FFFFFF',
...
export const MORE_ITEMS = [
  ...
  { id: 'civil',       icon: '📜', label: 'Boda Civil',     sub: 'Documentos y checklist',  color: '#FDF3E8' },
  ...
  { id: 'notas',       icon: '📝', label: 'Notas Maestras', sub: 'Tus Apple Notes aquí',    color: '#F0EBE3' },
]
